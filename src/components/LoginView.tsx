  ...
  if (isLoading && currentView === "login") {
    return (
      <div className="flex flex-col items-center justify-center min-h-[80vh] w-full">
        ...
        <p className="text-neutral-400 mt-4 font-mono text-sm">
          Verificando sesión...
        </p>
      </div>
    );
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh] w-full max-w-md mx-auto px-4">
      ...
      <form
        ...
        className="w-full bg-neutral-900/50 border border-neutral-800 p-8 rounded-2xl backdrop-blur-sm shadow-2xl relative overflow-hidden group"
      >
        {/* Decorative elements */}
        ...
        <div className="space-y-6 relative z-10">
          ...
          <div className="space-y-2">
            ...
            <div className="relative group/input">
              <User
                className="absolute left-4 top-1/2 -translate-y-1/2 text-neutral-500 group-focus-within/input:text-green-500 transition-colors"
                size={20}
              />
              <input
                type="text"
          ...
          {isGMMode && (
            <div className="space-y-2 animate-in slide-in-from-top-2 fade-in duration-300">
              ...
              <div className="relative group/input">
                <Lock
                  className="absolute left-4 top-1/2 -translate-y-1/2 text-red-500/50 group-focus-within/input:text-red-500 transition-colors"
                  size={20}
                />
                <input
                  type="password"
